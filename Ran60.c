...
void inisialisasiData() {
    jumlahMobil = 3; // Contoh isi 3 data default

    strcpy(dataMobil[0].merk, "Toyota");
    strcpy(dataMobil[0].model, "Avanza");
    dataMobil[0].tahun = 2020;
    strcpy(dataMobil[0].warna, "Hitam");

    strcpy(dataMobil[1].merk, "Honda");
    strcpy(dataMobil[1].model, "Civic");
    dataMobil[1].tahun = 2018;
    strcpy(dataMobil[1].warna, "Putih");

    strcpy(dataMobil[2].merk, "Suzuki");
    strcpy(dataMobil[2].model, "Ertiga");
    dataMobil[2].tahun = 2019;
    strcpy(dataMobil[2].warna, "Merah");

    printf("Data mobil telah diinisialisasi dengan data contoh.\n");
}
...
int main() {
    ...
    do {
        ...
        switch(pilihan) {
            case 1:
                inisialisasiData();
                tampilkanData();  // Menampilkan data langsung setelah inisialisasi
                break;
            case 2:
                inputDataMobil();
                break;
